...
args.add_argument('--lr', default=2.5e-4, type=float, help='Learning rate for agent training')
args.add_argument('--eps', default=1.0, type=float, help='Chance of taking random action')
args.add_argument('--eps_decay', default=1e-4, type=float, help='Decay for macro eps')
args.add_argument('--eps_sub', default=1.0, type=float, help='Chance of taking random action for sub policy')
args.add_argument('--eps_sub_decay', default=1e-3, type=float, help='Decay for sub policy eps')
args.add_argument('--bs', default=128, type=int, help='Batch size')
...
args.add_argument('--max_memory', default=50_000, type=int, help='Max macro memory')
