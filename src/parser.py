...
args.add_argument('--sparse', default=0, type=int, help='Sparsity, one in {0, 1, 2}')
...
args.add_argument('--max_time', default=10, type=int, help='Number of steps per policy')
args.add_argument('--n_subpolicy', default=2, type=int, help='Number of sub policies')
args.add_argument('--lr', default=1e-4, type=float, help='Learning rate for agent training')
args.add_argument('--eps', default=1.0, type=float, help='Chance of taking random action')
args.add_argument('--eps_decay', default=4e-5, type=float, help='Decay for macro eps')
args.add_argument('--eps_sub', default=0.2, type=float, help='Chance of taking random action for sub policy')
args.add_argument('--eps_sub_decay', default=1e-5, type=float, help='Decay for sub policy eps')
...
args.add_argument('--target_int', default=1000, type=int, help='Steps of training to update target network in dueling arch.')
args.add_argument('--max_memory', default=100_000, type=int, help='Max macro memory')
args.add_argument('--max_memory_sub', default=300_000, type=int, help='Max memory sub')
