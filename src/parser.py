...
args.add_argument('--hidd_ch', default=256, type=int, help='Number of hidden units per hidden channels')
...
args.add_argument('--eps_sub', default=0.1, type=float, help='Chance of taking random action for sub policy')
...
args.add_argument('--target_int', default=2000, type=int, help='Steps of training to update target network in dueling arch.')
args.add_argument('--max_memory', default=10_000, type=int, help='Max macro memory')
